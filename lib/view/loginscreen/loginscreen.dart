...
import 'package:enoikiou/view/homescreen/homescreen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(decoration: BoxDecoration(
        ...
        ("https://images.pexels.com/photos/919073/pexels-photo-919073.jpeg?auto=compress&cs=tinysrgb&w=600"),fit: BoxFit.fill)
      ),
        child: Column(
