...
//   Future<void> updateProduct(CarModel product) async {
//     await db
//         .collection(productsCollectionName)
...
//   Future<List<CarModel>> searchProductsUsingBarcode(String text) async {
//     List<CarModel> list = [];
//     try {
//       var data = await db
//           .collection(productsCollectionName)
...
//           .get();
//       list = data.docs
//           .map((e) => CarModel.fromQueryDocumentSnapshot(e))
//           .toList();
//     } on FirebaseException catch (e) {
